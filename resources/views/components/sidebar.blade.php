<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseCustomers" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Customers Option:</h6>
                <a class="collapse-item" href="/customers">Show Customers</a>
                <a class="collapse-item" href="cards.html">Add Service</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseServices" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Customers Option:</h6>
                <a class="collapse-item" href="/services">Show Services</a>
                <a class="collapse-item" href="cards.html">Add Service</a>
            </div>
        </div>
    </li>
    ...
    <div class="sidebar-card d-none d-lg-flex">
        ...
        <a class="btn btn-success btn-sm" href="#">Fork me!</a>
    </div>
